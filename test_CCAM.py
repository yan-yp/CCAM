...
from src.lightning.lightning_third import PL_LoFTR
...
if __name__ == '__main__':
    ...
    model = PL_LoFTR(config, train_mode=args.train_mode, pretrained_ckpt=args.ckpt_path, profiler=profiler, dump_dir=args.dump_dir)
