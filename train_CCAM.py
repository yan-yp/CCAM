...
from src.lightning.lightning_csformer import PL_LoFTR
...
def parse_args():
    ...
    parser.add_argument(
        '--train_mode', type=int, default=1,
        help='0 for test, 1 for train')
    parser.add_argument(
...
def main():
    ...
    model = PL_LoFTR(config, train_mode=args.train_mode, pretrained_ckpt=args.ckpt_path, profiler=profiler)
    ...
    # TensorBoard Logger
    logger = TensorBoardLogger(save_dir='logs', name=args.exp_name, default_hp_metric=False)
