...
from .loftr_module.fine_preprocess_csformer import FinePreprocess
from .utils.coarse_matching import CoarseMatching
from .utils.fine_matching import FineMatching

from .MultiScaleLocalFeature import MultiScaleLocalFeature, MultiScaleLocalFeature_Share
...
class CSFormer(nn.Module):
    def __init__(self, config):
        ...
        self.local_feat = MultiScaleLocalFeature_Share(dim=256)
